...
//=================
//Menu
let iconMenu = document.querySelector(".burger__icon");
if (iconMenu != null) {
	let delay = 500;
...
let navHeaderSearch = document.querySelector('.nav-header__search');
let headerForm = document.querySelector('.header__form');

navHeaderSearch.addEventListener("click", someClick);
...
//======================================================
let comInformationBodyItems = document.querySelectorAll('.com-information-body__item');
let comInformationBodyIcons = document.querySelectorAll('.com-information-body__icon');
for (let index = 0; index < comInformationBodyItems.length; index++) {
	const comInformationBodyItem = comInformationBodyItems[index];
	comInformationBodyItem.addEventListener("mouseover", function (e) {
		comInformationBodyItem.classList.add('_active');

	});
	comInformationBodyItem.addEventListener("mouseout", function (e) {
		comInformationBodyItem.classList.remove('_active');
	});
}
//===========================================

const video = document.querySelector('#videoitem');
const videoPley = document.querySelector('.video__pley');
//const videoStop = document.querySelector('.video__stop');
video.removeAttribute("controls")
videoPley.addEventListener("click", function (e) {
	videoPley.classList.add('_active');
	//videoStop.classList.add('_shou');
	//videoPley.controls = "";
	video.setAttribute("controls", "controls")
	video.play();
});
//videoStop.addEventListener("click", function (e) {
	//videoPley.classList.remove('_active');
	//videoStop.classList.remove('_shou');
	//video.pause();
//});
...
if (document.querySelector('.what__columns')) {
	const whatRow = new Swiper('.what__row', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
